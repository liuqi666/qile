...
if ($operation == 'display') {
    ...
    $sql = "select o.* , a.realname as arealname,a.mobile as amobile,a.province as aprofince ,a.city as acity , a.area as aarea,a.address as aaddress, d.dispatchname,r.status as refundstatus from " . tablename('ewei_shop_order') . " o" . " left join " . tablename('ewei_shop_order_refund') . " r on r.orderid=o.id and ifnull(r.status,'')<>''" . " left join " . tablename('ewei_shop_member') . " m on m.openid=o.openid and m.uniacid =  o.uniacid " . " left join " . tablename('ewei_shop_member_address') . " a on a.id=o.addressid " . " left join " . tablename('ewei_shop_dispatch') . " d on d.id = o.dispatchid " . " where $condition $statuscondition ORDER BY o.createtime DESC,o.status DESC  ";
    ...
    $total              = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('ewei_shop_order') . " o " . " left join " . tablename('ewei_shop_order_refund') . " r on r.orderid=o.id and ifnull(r.status,'')<>''" . " left join " . tablename('ewei_shop_member') . " m on m.openid=o.openid  and m.uniacid =  o.uniacid" . " left join " . tablename('ewei_shop_member_address') . " a on o.addressid = a.id " . " WHERE $condition $statuscondition", $paras);
    $totalmoney         = pdo_fetchcolumn('SELECT ifnull(sum(o.price),0) FROM ' . tablename('ewei_shop_order') . " o " . " left join " . tablename('ewei_shop_order_refund') . " r on r.orderid=o.id and ifnull(r.status,'')<>''" . " left join " . tablename('ewei_shop_member') . " m on m.openid=o.openid  and m.uniacid =  o.uniacid" . " left join " . tablename('ewei_shop_member_address') . " a on o.addressid = a.id " . " WHERE $condition $statuscondition", $paras);
    $totals             = array();
    $totals['all']      = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('ewei_shop_order') . " o " . " left join " . tablename('ewei_shop_order_refund') . " r on r.orderid=o.id and ifnull(r.status,'')<>''" . " left join " . tablename('ewei_shop_member') . " m on m.openid=o.openid  and m.uniacid =  o.uniacid" . " left join " . tablename('ewei_shop_member_address') . " a on o.addressid = a.id " . " WHERE o.uniacid = :uniacid and o.deleted=0", $paras);
    $totals['status_1'] = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('ewei_shop_order') . " o " . " left join " . tablename('ewei_shop_order_refund') . " r on r.orderid=o.id and ifnull(r.status,'')<>''" . " left join " . tablename('ewei_shop_member') . " m on m.openid=o.openid  and m.uniacid =  o.uniacid" . " left join " . tablename('ewei_shop_member_address') . " a on o.addressid = a.id " . " WHERE $condition and o.status=-1", $paras);
    $totals['status0']  = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('ewei_shop_order') . " o " . " left join " . tablename('ewei_shop_order_refund') . " r on r.orderid=o.id and ifnull(r.status,'')<>''" . " left join " . tablename('ewei_shop_member') . " m on m.openid=o.openid  and m.uniacid =  o.uniacid" . " left join " . tablename('ewei_shop_member_address') . " a on o.addressid = a.id " . " WHERE $condition and o.status=0", $paras);
    $totals['status1']  = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('ewei_shop_order') . " o " . " left join " . tablename('ewei_shop_order_refund') . " r on r.orderid=o.id and ifnull(r.status,'')<>''" . " left join " . tablename('ewei_shop_member') . " m on m.openid=o.openid  and m.uniacid =  o.uniacid" . " left join " . tablename('ewei_shop_member_address') . " a on o.addressid = a.id " . " WHERE $condition and o.status=1", $paras);
    $totals['status2']  = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('ewei_shop_order') . " o " . " left join " . tablename('ewei_shop_order_refund') . " r on r.orderid=o.id and ifnull(r.status,'')<>''" . " left join " . tablename('ewei_shop_member') . " m on m.openid=o.openid  and m.uniacid =  o.uniacid" . " left join " . tablename('ewei_shop_member_address') . " a on o.addressid = a.id " . " WHERE $condition and o.status=2", $paras);
    $totals['status3']  = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('ewei_shop_order') . " o " . " left join " . tablename('ewei_shop_order_refund') . " r on r.orderid=o.id and ifnull(r.status,'')<>''" . " left join " . tablename('ewei_shop_member') . " m on m.openid=o.openid  and m.uniacid =  o.uniacid" . " left join " . tablename('ewei_shop_member_address') . " a on o.addressid = a.id " . " WHERE $condition and o.status=3", $paras);
    $totals['status4']  = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('ewei_shop_order') . " o " . " left join " . tablename('ewei_shop_order_refund') . " r on r.orderid=o.id and ifnull(r.status,'')<>''" . " left join " . tablename('ewei_shop_member') . " m on m.openid=o.openid  and m.uniacid =  o.uniacid" . " left join " . tablename('ewei_shop_member_address') . " a on o.addressid = a.id " . " WHERE $condition and o.refundid<>0 and r.status=0", $paras);
    $totals['status5']  = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('ewei_shop_order') . " o " . " left join " . tablename('ewei_shop_order_refund') . " r on r.orderid=o.id and ifnull(r.status,'')<>''" . " left join " . tablename('ewei_shop_member') . " m on m.openid=o.openid  and m.uniacid =  o.uniacid" . " left join " . tablename('ewei_shop_member_address') . " a on o.addressid = a.id " . " WHERE $condition and r.status=1", $paras);
    ...
    $totals             = array();
    $totals['all']      = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('ewei_shop_order') . " o " . " left join " . tablename('ewei_shop_order_refund') . " r on r.orderid=o.id and ifnull(r.status,'')<>''" . " left join " . tablename('ewei_shop_member') . " m on m.openid=o.openid  and m.uniacid =  o.uniacid" . " left join " . tablename('ewei_shop_member_address') . " a on o.addressid = a.id " . " WHERE $condition", $paras);
    $totals['status_1'] = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('ewei_shop_order') . " o " . " left join " . tablename('ewei_shop_order_refund') . " r on r.orderid=o.id and ifnull(r.status,'')<>''" . " left join " . tablename('ewei_shop_member') . " m on m.openid=o.openid  and m.uniacid =  o.uniacid" . " left join " . tablename('ewei_shop_member_address') . " a on o.addressid = a.id " . " WHERE $condition and o.status=-1", $paras);
    $totals['status0']  = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('ewei_shop_order') . " o " . " left join " . tablename('ewei_shop_order_refund') . " r on r.orderid=o.id and ifnull(r.status,'')<>''" . " left join " . tablename('ewei_shop_member') . " m on m.openid=o.openid  and m.uniacid =  o.uniacid" . " left join " . tablename('ewei_shop_member_address') . " a on o.addressid = a.id " . " WHERE $condition and o.status=0", $paras);
    $totals['status1']  = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('ewei_shop_order') . " o " . " left join " . tablename('ewei_shop_order_refund') . " r on r.orderid=o.id and ifnull(r.status,'')<>''" . " left join " . tablename('ewei_shop_member') . " m on m.openid=o.openid  and m.uniacid =  o.uniacid" . " left join " . tablename('ewei_shop_member_address') . " a on o.addressid = a.id " . " WHERE $condition and o.status=1", $paras);
    $totals['status2']  = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('ewei_shop_order') . " o " . " left join " . tablename('ewei_shop_order_refund') . " r on r.orderid=o.id and ifnull(r.status,'')<>''" . " left join " . tablename('ewei_shop_member') . " m on m.openid=o.openid  and m.uniacid =  o.uniacid" . " left join " . tablename('ewei_shop_member_address') . " a on o.addressid = a.id " . " WHERE $condition and o.status=2", $paras);
